...
<section class="panel">
    <form method="POST" action="{{ route('settings.launcher.update') }}" class="stack">
        @csrf
        @method('PUT')
        <div>
...
<section class="panel" style="margin-top:1rem;background:#f8fffd;">
